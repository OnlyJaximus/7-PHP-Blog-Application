...
if (isset($_POST['post_update'])) {
    ...
    $query = "UPDATE posts 
    SET category_id='$category_id', name='$name', slug='$slug', description='$description', image='$update_filename',
...
if (isset($_POST['category_update'])) {
    ...
    $query = "UPDATE categories SET
             name='$name', slug='$slug', description='$description', meta_title='$meta_title', meta_description='$meta_description',
...
if (isset($_POST['category_add'])) {
    ...
    $query_run_add_category = mysqli_query($con, $query);

    if ($query_run_add_category) {
...
if (isset($_POST['user_delete'])) {
    ...
    $query_run_dlt_user = mysqli_query($con, $query);

    if ($query_run_dlt_user) {
        $_SESSION['message'] = "User/Admin Deleted Successfuly";
        header('Location: view-register.php');
        exit(0);
    } else {
        $_SESSION['message'] = "Deleted User/Admin Went Wrong!";
        header('Location: view-register.php');
        exit(0);
    }
} else {
...
if (isset($_POST['update_user'])) {
    ...
    $query = "UPDATE users SET fname='$fname', lname='$lname', 
                    email='$email', password='$password', role_as='$role_as', status='$status'
                    WHERE id='$user_id'";

    $query_run_update = mysqli_query($con, $query);
    if ($query_run_update) {
        ...
        $_SESSION['message'] = "Update Went Wrong!";
        header('Location: view-register.php');
        exit(0);
    }
}
