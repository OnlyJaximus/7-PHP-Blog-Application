...
if (isset($_POST['register_btn'])) {
    ...
    if ($password == $confirm_password) {
        ...
        if (mysqli_num_rows($checkmail_run) > 0) {
            // Aleready Email Exists
            $_SESSION['message'] = "Aleready Email Exists";
            ...
            if ($user_query_run) {
                $_SESSION['message'] = "Registred Succesfully";
        ...
        $_SESSION['message'] = "Password and Confirm Passwod does not Match";
        header("Location: register.php");
        exit(0);
    }
} else {
